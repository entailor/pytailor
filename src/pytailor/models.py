...
#   timestamp: 2020-10-28T11:00:08+00:00
...
class TaskOperation(BaseModel):
    type: Optional[TaskOperationType] = None
...
class TaskExecutionData(BaseModel):
    ...
    processing_id: Optional[str] = Field(
        None,
        description="Use the processing id the retrieve PENDING results from /task/pending-results/{id}",
        title="Processing id",
    )
