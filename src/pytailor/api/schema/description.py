"""
Created on Wed Oct 16 16:19:14 2019
...
class Description:
    ...
    def from_dag(cls, dag, wf_def_name='', wf_def_description=''):
        ...
        if wf_def_description:
            ...
            description = """
               ...
               All other strings in this document are auto generated from docstrings in the code and renderings of the dag implemetation 

               """

        readme = [f'# Workflow: {wf_def_name}', '\n\n',
                  description,
    ...
    def get_docstring(function):
        ...
        docstring = importlib.import_module(import_string[0]).__dict__.get(
            import_string[1]).__doc__
        if docstring:
            return docstring
        else:
