...
#   timestamp: 2020-09-03T08:42:03+00:00
...
class WorkflowDefinition(BaseModel):
    ...
    version: Optional[int] = Field(
        None, title='the version of this workflow definition'
    )
    json_definition: Optional[Dict[str, Any]] = Field(
        None, title='the definition as json'
    )
