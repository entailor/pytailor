...
inputs1 = {"wf_run_name": "of_lift_default",
          "create_array_environmental_conditions":{
              ...
              "WaveDirection": {
                  ...
                  "start": 180, "stop": 195, "step": 16
                },
              "rulebased_wavegamma": True,
              "WaveHs": {
                    # "start": 1.5, "stop": 4.5, "step": 1.5
                    "start": 0.5, "stop": 1.5, "step": 1.1
                  },
              "WaveTp": {
                    # "start": 2, "stop": 6, "step": 2
                    "start": 3, "stop": 4, "step": 1.1

                  },
            "orcaflex_def": { # maps to all orcaflex parameters #  Only allows for constant values
                "Environment": {"NumberOfWaveTrains": 1, #  does not support multiple wave trains: if tp, hs, gamma is given, then it is replaced by array from previous task
          ...
          "report_orcaflex_parameters_def": { # to select which parameters you want to be tabulated
                ...
                "Main Winch": ["Stiffness"] # all object variables in datfile are available
                }
            },
          "populate_seeds": { # populate seeds per datfile
               "nr_seeds": 1
              },
          "limitations_def": {
...
json_schema1 = {'$schema': 'http://json-schema.org/schema#',
               'properties': {'panels': {'items': {'properties': {'SN_curves': {'items': {'type': 'integer'},
                                                                                'type': 'array'},
                                                                  'id': {'type': 'string'}},
...
json_schema3_defaults = {
    "General": {'Time': {'Timestep': 0.1}
                }
}
                ...
                "type_data": [
                    {
                        "object_data": [
                            {
                                "data_name": "LineType",
                                "data_value": ["Mooring line type", "Mooring line type"]
                            }
                        ]
                    },
                    {
