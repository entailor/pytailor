...
with DAG(name="DAG") as dag_2lvl_dup:
    ...
    t1 = PythonTask(
        name="T1", function="builtins.list", args=[[3, 4, 5]], output_to="out_from_T1"
    )
...
target_output = {
    ...
    "'newfile1.txt'}",
    "out_from_T2": {"0": "newfile1.txt", "1": "newfile1.txt", "2": "newfile1.txt"},
    "out_from_T3": {
        "0": {"0": "newfile2.txt", "1": "newfile2.txt", "2": "newfile2.txt"},
        "1": {"0": "newfile2.txt", "1": "newfile2.txt", "2": "newfile2.txt"},
        "2": {"0": "newfile2.txt", "1": "newfile2.txt", "2": "newfile2.txt"},
    },
    "out_from_T4": {
        "0": {"0": "3", "1": "4", "2": "5"},
        "1": {"0": "3", "1": "4", "2": "5"},
    ...
    "out_from_T6": {"0": "[0, 1, 2]", "1": "['a', 'b', 'c']", "2": "[6, 7, 8]"},
    "out_from_T7": {
        "0": "{'0': 'newfile2.txt', '1': 'newfile2.txt', '2': " "'newfile2.txt'}",
        "1": "{'0': 'newfile2.txt', '1': 'newfile2.txt', '2': " "'newfile2.txt'}",
        "2": "{'0': 'newfile2.txt', '1': 'newfile2.txt', '2': " "'newfile2.txt'}",
    },
    "out_from_T8": {"0": "newfile1.txt", "1": "newfile1.txt", "2": "newfile1.txt"},
